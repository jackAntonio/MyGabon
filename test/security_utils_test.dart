...
void main2() {
  group('AuthTokenService - JWT Tokens', () {
    final jwtSecret = 'test-secret-minimum-32-chars-required-for-jwt-security';
    ...
    test('generateAccessToken should create valid token', () {
      ...
      expect(token.split('.').length, 3); // JWT format: header.payload.signature
    });
