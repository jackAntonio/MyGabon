...
class ReviewProvider extends ChangeNotifier {
  ...
  Map<String, UserRatingSummary?> _userRatings = {};
  Map<String, List<UserReview>> _userReviews = {};
  ...
  /// Delete review
  Future<bool> deleteReview(String reviewId, String userId, {required String deletedBy}) async {
    try {
      _isLoading = true;
      _error = null;
      notifyListeners();
